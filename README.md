...
* **Firebase Integration** — Stores form submissions securely using Firebase Realtime Database.
* **Modern UI** — Clean and user-friendly design inspired by the original SMIT form.
* **Reusable Components** — Input fields, dropdowns, and submit functionality structured for scalability.
...
* **Submission Handling** – Sends form data to Firebase.
...
```bash
git clone [https://github.com/amna-mohsin/SMIT-Form-Clone.git](https://github.com/amna-mohsin/SMIT-Form-Clone.git)
````
...
<img width="848" height="576" alt="image" src="https://github.com/user-attachments/assets/60dac67a-adf0-453d-a4e3-017ca5fce916" />
